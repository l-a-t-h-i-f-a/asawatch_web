...
class SinkronRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Sama seperti PUT /sesi/{id}: hasil deteksi ikut disinkronkan.
            'data.sesi.*.hasil' => ['nullable', 'array'],
            'data.sesi.*.hasil.indeks_glikemik_perkiraan' => ['nullable', 'string', 'max:32'],
            'data.sesi.*.hasil.keyakinan' => ['nullable', 'numeric', 'between:0,1'],
            'data.sesi.*.hasil.dikoreksi_user' => ['nullable', 'boolean'],
            'data.sesi.*.hasil.total' => ['nullable', 'array'],
            'data.sesi.*.hasil.total.kalori' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.total.karbohidrat' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.total.protein' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.total.lemak' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.total.gula_total' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.total.serat' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.zat_tidak_lengkap' => ['nullable', 'array'],
            'data.sesi.*.hasil.zat_tidak_lengkap.*' => ['string', 'max:32'],
            'data.sesi.*.hasil.makanan' => ['nullable', 'array'],
            'data.sesi.*.hasil.makanan.*.urutan' => ['nullable', 'integer', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nama' => ['required_with:data.sesi.*.hasil.makanan', 'string', 'max:255'],
            'data.sesi.*.hasil.makanan.*.porsi' => ['nullable', 'string', 'max:255'],
            'data.sesi.*.hasil.makanan.*.estimasi_gram' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nutrisi' => ['nullable', 'array'],
            'data.sesi.*.hasil.makanan.*.nutrisi.kalori' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nutrisi.karbohidrat' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nutrisi.protein' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nutrisi.lemak' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nutrisi.gula_total' => ['nullable', 'numeric', 'min:0'],
            'data.sesi.*.hasil.makanan.*.nutrisi.serat' => ['nullable', 'numeric', 'min:0'],
